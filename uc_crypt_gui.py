...
class Ui_UCrypt(object):
    ...
    def retranslateUi(self, UCrypt):
        ...
        UCrypt.setWindowTitle(_translate("UCrypt", ""))
        self.title.setText(_translate("UCrypt", ""))
        self.txt_encrypt.setText(_translate("UCrypt", "Зашифрованное сообщение"))
        self.txt_decrypt.setText(_translate("UCrypt", "Расшифрованное сообщение"))
        self.msg_to_encrypt.setPlaceholderText(_translate("UCrypt", "Напечатайте сообщение для зашифровки"))
        self.msg_to_decrypt.setPlaceholderText(_translate("UCrypt", "Напечатайте сообщение для расшифровки"))
        self.msg_encrypt_key.setPlaceholderText(_translate("UCrypt", "8-ми значный секретный ключ"))
        self.msg_decrypt_key.setPlaceholderText(_translate("UCrypt", "8-ми значный секретный ключ"))
        self.msg_encrypted.setPlaceholderText(_translate("UCrypt", "Зашифрованное сообщение будт отображено здесь"))
        self.msg_decrypted.setPlaceholderText(_translate("UCrypt", "Расщифрованное сообщение будет отображено здесь"))
        self.button_encrypt.setText(_translate("UCrypt", "ЗАШИФРОВАТЬ"))
        self.button_decrypt.setText(_translate("UCrypt", "РАСШИФРОВАТЬ"))
